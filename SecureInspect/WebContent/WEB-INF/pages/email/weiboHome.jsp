...
function getPageList(obj, curPage){
	...
	var url = "/SecureInspect/mvc/getPageListBySiteId";
	$.ajax({
		cache:false,
		sync: false,
		type:"post",
		data: {"siteId":siteId, "curPage": curPage},
		url:url,
		dataType:"html",
		success:function(data){
			$(".navDiv a").removeClass("clk");
...
function loadSite(){
	 $.ajax({
		...
		cache : false,
		type : "POST",
		url : "/SecureInspect/mvc/firstLoadSite",
		dataType : "html",
		success : function(data) {
			$(".siteDiv").show();
			$(".siteDiv").html(data);
...
function advSearch(){
	...
	//$("input[name=position]").val($(".position").val());
...
function getDataByPage(curPage){
	...
	var data = null;
	switch(byPageFlag){
	case "siteId" : url = "/SecureInspect/mvc/getPageListBySiteId"; var siteId = $("." + type + "Div input[name=siteId]").val();data={"siteId": siteId, "curPage" : curPage};
		break;
	...
	case "filebrief" : url = "/SecureInspect/mvc/briefSearchfile"; data = $("#searchForm").serialize();
		break;
	case "siteadv" : url = "/SecureInspect/mvc/advSearchsite"; data = $("#searchForm").serialize();
		break;
...
<div class="functionDiv">
	...
	<select class="searchSelect">
		...
		<option value="site_name">网站名称</option>
	</select>
