...
<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %> 
	...
	<ul>
		...
		<li>
			...
			<a class="URL" href="${item.location}" title="${item.location}" target="_blank">${item.location}</a>
			...
			<span class="detail"><input type="button" value="展开" onclick="getPageListByTaskId(this, 1)"></span>
