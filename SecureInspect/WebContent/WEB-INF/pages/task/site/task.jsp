...
<script type="text/javascript">
	 ...
	 function getDataByPage(clickPage){
		 var url = "/SecureInspect/task/siteTask0/" + clickPage;
		 $.ajax({
			async : false,
			cache : false,
			type : "GET",
	...
	function addTask(){
		...
		obj.type="site";
		obj.dirname="";
		if(obj.location == "" || obj.taskName=="" || obj.kwds == ""){
			alert("请将信息填写完整");
			return;
		}
...
<body>
	...
	<div class="downDoc"></div>
		...
		<ul class="addUl">
			<li>
				<span>网站名称：</span><input type="text" name="taskName" id="taskName">
			</li>
			<li>
				<span>网站URL：</span><input type="text" name="location" id="location">
			</li>
			<li class="kwdLi">
				<span>关键字：</span>
