...
public class ChineseToSpellUtil {
	 ...
	 * 添加生僻字
	 * @param cnWord 生僻字     
	 * @param spell 生僻字的拼音, 如果拼音以 a, o ,e 开头，
	 *  请将开头分别改为 'a, 'o, 'e， 如：安('an) 
	 **/
	...
	public static String getSpell(String cnStr, boolean onlyFirstSpell) {
			...
			if (ascii == 0){
				...
				if(spell == null || spell.length() == 0){
					...
					if(onlyFirstSpell){
						...
						spell = String.valueOf(spell.charAt(0)).toUpperCase() + String.valueOf(spell.substring(1));
						sb.append(spell);
						}
					}
				}
		...
		public static void main(String[] args) {
			//String[] s = {"中国海关总署",
					...
					//"棽 燊 顕 峣 山 "};
			String str = "百度";
			System.out.println(str+" 的全拼:" + getSpell(str, false));
